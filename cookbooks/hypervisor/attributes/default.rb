default['hypervisor']['packages'] = %w[webhook ttyd jo jq bash dnsmasq gnu-ipcalc git netdata nginx qemus pwgen ts grub2-bhyve edk2-bhyve uefi-edk2-bhyve-csm vm-bhyve cdrkit-genisoimage dmidecode]
