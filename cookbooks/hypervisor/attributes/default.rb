default['hypervisor']['packages'] = %w[webhook ttyd jo jq bash dnsmasq gnu-ipcalc git netdata nginx qemu-utils pwgen ts grub2-bhyve uefi-edk2-bhyve uefi-edk2-bhyve-csm cdrkit-genisoimage dmidecode]
...
default['hypervisor']['repo']['vm-bhyve'] = 'https://github.com/churchers/vm-bhyve.git'
...
default['hypervisor']['zfs']['filesystem'] = 'zroot/vm'
default['hypervisor']['zfs']['mountpoint'] = '/vm'
